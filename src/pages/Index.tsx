...
const Index = () => {
  ...
  // Volume data for mini bar chart
      ...
      <div className="ml-[220px] p-7">
        ...
        <div className="flex gap-5">
          ...
          >
            ...
            {/* Table */}
            <div className="divide-y" style={{ borderColor: "#2C2C2A" }}>
              {clients.map((client, i) => {
                ...
                return (
                  <div
                    key={client.id}
                    className="px-5 py-3 flex items-center gap-4 hover:bg-[#1E1E20] cursor-pointer transition-colors"
                ...
                {clients.map((client) => {
                  ...
                  return (
                    <div key={client.id} className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] w-6 text-right tabular-nums" style={{ color: "#888780" }}>
                        {docCount}
                      </span>
                    </div>
                  );
              ...
              {recentActivities.map((activity, i) => (
                <div key={i} className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-xs leading-relaxed" style={{ color: "#B4B2A9" }}>
                      {activity.title}
                    </p>
