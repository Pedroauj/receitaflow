    ...
    <div className="w-full">
      <div className="mx-auto w-full max-w-[1560px] px-6 py-6">
        ...
        <motion.div
          ...
          className="mb-5 rounded-2xl border border-border bg-card/70 p-6 shadow-sm backdrop-blur-sm"
        >
          ...
          <div
            ...
            className="cursor-pointer rounded-2xl border border-dashed border-border bg-background/40 p-12 text-center transition-colors hover:border-primary/50"
          >
            {file ? (
          ...
          <div className="mt-6 flex justify-start">
            <Button disabled={!file || processing} onClick={handleProcess}>
